								...
								<div class="uk-width-3-4">
									<div class="uk-form-row">
											...
											@if ($payroll_templates != null)
											     {{ Form::select('sss_sched', ['Monthly' => 'Monthly', 'Semi-monthly' => 'Semi-monthly','Annualy'=>'Annualy'] , $payroll_templates->sss_sched, array('class'=>'uk-form-width-medium')) }}
											 @else
												 {{ Form::select('sss_sched', ['Monthly' => 'Monthly', 'Semi-monthly' => 'Semi-monthly','Annualy'=>'Annualy'] , '', array('class'=>'uk-form-width-medium')) }}
											 @endif
											</div>
									</div>
								</div>
							...
							<div class="uk-grid">
								...
								<div class="uk-width-3-4">
									<div class="uk-form-row">
											<div class="uk-form-controls">
												@if ($payroll_templates != null)
											     {{ Form::select('pagibig_sched', ['Monthly' => 'Monthly', 'Semi-monthly' => 'Semi-monthly','Annualy'=>'Annualy'] , $payroll_templates->pagibig_sched, array('class'=>'uk-form-width-medium')) }}
											 @else
												 {{ Form::select('pagibig_sched', ['Monthly' => 'Monthly', 'Semi-monthly' => 'Semi-monthly','Annualy'=>'Annualy'] , '', array('class'=>'uk-form-width-medium')) }}
											 @endif
							...
							<div class="uk-grid">
								...
								<div class="uk-width-3-4">
									<div class="uk-form-row">
											<div class="uk-form-controls">
												@if ($payroll_templates != null)
											     {{ Form::select('philhealth_sched', ['Monthly' => 'Monthly', 'Semi-monthly' => 'Semi-monthly','Annualy'=>'Annualy'] , $payroll_templates->philhealth_sched, array('class'=>'uk-form-width-medium')) }}
											 @else
												 {{ Form::select('philhealth_sched', ['Monthly' => 'Monthly', 'Semi-monthly' => 'Semi-monthly','Annualy'=>'Annualy'] , '', array('class'=>'uk-form-width-medium')) }}
											 @endif
